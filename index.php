...
$absen_schedule = [
  ...
  'Friday'    => ['datang_start' => '06:00:00', 'datang_cepat_end' => '06:30:00', 'datang_tepat_waktu_start' => '06:30:01', 'datang_tepat_waktu_end' => '07:30:00', 'datang_end' => '09:00:00', 'menunggu_start' => '09:00:01', 'pulang_cepat_start' => '11:15:00', 'menunggu_end' => '11:44:59', 'pulang_start' => '11:45:00', 'pulang_tepat_waktu_end' => '13:00:00', 'pulang_end' => '15:00:00'],
...
if ($waktu >= $schedule['datang_start'] && $waktu <= $schedule['pulang_cepat_start']) {
          ...
          <tbody>
            <?php while ($key = mysqli_fetch_assoc($result_sql)) : ?>
              ...
              <tr>
                ...
                <td width="225px"><?= $pangkat; ?>/<?= $golongan; ?></td>

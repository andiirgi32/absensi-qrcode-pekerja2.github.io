...
if ($_FILES['fotopekerja']['name'] != "") {
  ...
  if (!in_array($ext, $ekstensi)) {
    ...
    if ($ukuran < 204488000) {
      ...
      mysqli_query($conn, "UPDATE pekerja SET nip='$nip', nama='$nama', fotopekerja='$xx', jabatanid='$jabatanid', pangkatid='$pangkatid', jk='$jk' where idpekerja='$idpekerja'");
      echo "<script type='text/javascript'>
              setTimeout(function () { 
                swal({
  ...
  mysqli_query($conn, "UPDATE pekerja SET nip='$nip', nama='$nama', jabatanid='$jabatanid', pangkatid='$pangkatid', jk='$jk' where idpekerja='$idpekerja'");
  echo "<script type='text/javascript'>
              setTimeout(function () { 
                swal({
                        title: 'Data Berhasil Diubah',
